    ...
    for x = xmin, xmax, 1 do
      ...
      for y = ymin, ymax, ystride do
        for z = zmin, zmax, zstride do
          ...
          if (x == xmin or x == xmax) and not (z == zmin or z == zmax) and not preserve[vdata[npos]] then
          ...
          elseif (z == zmin or z == zmax) and not (x == xmin or x == xmax) and not preserve[vdata[npos]] then
